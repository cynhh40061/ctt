...
public class MemBean implements Serializable {
	private static final long serialVersionUID = 4996586556226989532L;
	private long accId;
	...
	private String bankCardBranches;
	private String area;
	...
	public String getBankCardBranches() {
		return bankCardBranches;
	}

	public void setBankCardBranches(String bankCardBranches) {
		this.bankCardBranches = bankCardBranches;
	}
