...
public class GameDefaultCmds {
	...
	public static final String  WIN_TIMES = "182";
	public static final String  OPPONENT_WIN_TIMES = "184";
	public static final String  MAX_LIVE_POINT = "186";
	
	public static final String  OPPONENT_GET_START_ROBOT = "188";
	public static final String  OPPONENT_GET_STOP_ROBOT = "190";
	
	public static final String  VIDEO_INFO = "192";
	
	public static final String  ADD_MONEY = "194";
	public static final String  SUB_MONEY = "196";
	
	public static final String  SET_ROLE = "197";
	public static final String  GET_ROLE = "198";
	public static final String  OPPONENT_ROLE = "200";
	
	public static final String  PING = "201";
	public static final String  PONG = "202";
	
	public static final String  SET_SHUTDOWN_TIME = "205";
	public static final String  GET_SHUTDOWN_TIME_OK = "206";
	public static final String  SET_SHUTDOWN_TIME_NOW = "207";	
	public static final String  GET_SHUTDOWN_TIME_FAIL = "208";
	
	public static final String  PUNCHE_INFO = "210";
