...
function LotteryLowfreqAmountSet(){
	...
	getLotteryLotteryLowfreqAmountAjax();
}
...
function LotteryLowfreqAmountSet_into(){
	...
	if(document.getElementsByName("lotteryAmountInfo").length!=1){
		...
		str += '\n<input type="hidden" name="lotteryLowfreqAmountSetTypePage" value=1>';// 彩種頁
		
		str += '\n<input type="hidden" name="lotteryMark6PlayedPage" value=1>';// 六合彩玩法頁
		str += '\n<input type="hidden" name="lotteryMark6MidPage" value=1>';// 六合彩母單頁
		
		str += '\n<input type="hidden" name="lotteryLowfreqAmountSetAmountType" value=1>';// 賠率頁
		
		str += '\n<input type="hidden" name="lotteryLowfreqAmountSetList" value="">';// titleList
		
		str += '\n<input type="hidden" name="lotteryLowfreqAmountSetInfo" value="">';// detailInfo
...
function getLotteryLotteryLowfreqAmountAjax() {
	var str = '';
	...
	if (typeof Lottery_XHR != "undefined" && Lottery_XHR != null) {
		str = "tokenId=" + encodeURIComponent(getEle("tokenId").value) + 
			"&handicap=" + getEle("lotteryLowfreqAmountSetHandicapPage").value + 
			"&type=" + getEle("lotteryLowfreqAmountSetTypePage").value + 
			"&amountType=" + getEle("lotteryLowfreqAmountSetAmountType").value;
		...
		Lottery_XHR.open("POST", "./LotteryLowfreqAmountSet!getUpperSwitchInfo.php?date=" + getNewTime(), true);
...
function lotterySwitchDetailAjax(val) {
	...
	if (typeof Lottery_XHR != "undefined" && Lottery_XHR != null) {
		...
		Lottery_XHR.open("POST", "./LotteryLowfreqAmountSet!getSwitchDetail.php?date=" + getNewTime(), true);
		Lottery_XHR.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		Lottery_XHR.send(str);
		enableLoadingPage();
	}
...
function updateLotterySwitchAjax(str) {
	...
	if (typeof Lottery_XHR != "undefined" && Lottery_XHR != null) {
		...
		Lottery_XHR.open("POST", "./LotteryLowfreqAmountSet!updateLotterySwitch.php?date=" + getNewTime(), true);
		Lottery_XHR.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function lotteryAmountAjax() {
	...
	if (typeof Lottery_XHR != "undefined" && Lottery_XHR != null) {
		...
		Lottery_XHR.open("POST", "./LotteryLowfreqAmountSet!getLotteryAmountInfo.php?date=" + getNewTime(), true);
		Lottery_XHR.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		Lottery_XHR.send(tmpStr);
		enableLoadingPage();
	}
...
function upadteDescriptionAjax(str) {
	...
	if (typeof Lottery_XHR != "undefined" && Lottery_XHR != null) {
		...
		Lottery_XHR.open("POST", "./LotteryLowfreqAmountSet!upadteDescription.php?date=" + getNewTime(), true);
		Lottery_XHR.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		Lottery_XHR.send(tmpStr);
		enableLoadingPage();
	}
...
function updateAmountInfoAjax(compareList,amountLogList) {
	...
	if (typeof Lottery_XHR != "undefined" && Lottery_XHR != null) {
		...
		Lottery_XHR.open("POST", "./LotteryLowfreqAmountSet!updateAmountInfo.php?date=" + getNewTime(), true);
		Lottery_XHR.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		Lottery_XHR.send(tmpStr);
		enableLoadingPage();
	}
...
function upadteHandicapAjax(str) {
	...
	if (typeof Lottery_XHR != "undefined" && Lottery_XHR != null) {
		...
		Lottery_XHR.open("POST", "./LotteryLowfreqAmountSet!upadteHandicap.php?date=" + getNewTime(), true);
		Lottery_XHR.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		Lottery_XHR.send(tmpStr);
		enableLoadingPage();
	}
...
function lotterySwitchSettingLogAjax() {
	...
	if (typeof Lottery_XHR != "undefined" && Lottery_XHR != null) {
		...
		Lottery_XHR.open("POST", "./LotteryLowfreqAmountSet!getLotterySwitchSettingLog.php?date=" + getNewTime(), true);
		Lottery_XHR.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		Lottery_XHR.send(tmpStr);
		enableLoadingPage();
	}
		...
		if (Lottery_XHR.status == 200) {
			try {
				if (isJSON(Lottery_XHR.responseText)) {
					var json = JSON.parse(Lottery_XHR.responseText);
					if (checkTokenIdfail(json)) {
						getEle("LotteryLowfreqAmountSettingLog").value = Lottery_XHR.responseText;
						if(!isNull(json.LotteryLowfreqAmountSettingLog)){
...
function lotteryAmountSettingLogAjax() {
	...
	if (typeof Lottery_XHR != "undefined" && Lottery_XHR != null) {
		...
		Lottery_XHR.open("POST", "./LotteryLowfreqAmountSet!getLotteryAmountSettingLog.php?date=" + getNewTime(), true);
		Lottery_XHR.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		Lottery_XHR.send(tmpStr);
		enableLoadingPage();
	}
