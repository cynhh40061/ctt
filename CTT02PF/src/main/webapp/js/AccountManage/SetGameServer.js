...
function SetGameServer_GameServer(){
	SetGameServer_into();
	GameServer();
	getGameServerDataAjax();
}

function SetGameServer_GameParam(){
	SetGameServer_into();
	showSetGameParamPageAjax();
}

//<input type="hidden" name="setGameParamData" value="">
//<input type="hidden" name="gameServerData" value="">

function SetGameServer_into(){
	var str = '';
	if(document.getElementsByName("setGameParamData").length!=1){
		str += '\n<input type="hidden" name="setGameParamData" value="">';
		str += '\n<input type="hidden" name="gameServerData" value="">';
	}
	if(str!=''){
...
function showGameSetLog() {
	...
	str[4]='<a href="javascript:void(0);" onclick="firstGameSetLogPage();" class="backward"></a>';
	str[5]='<a href="javascript:void(0);" onclick="previousGameSetLogPage();" class="backward-fast"></a>';
	str[6]='<span>總頁數：<i id= "displayNowLogPage">1</i><span>/</span><i id = "displayNowLogMaxPage">1</i>頁</span>';
	str[7]='<a href="javascript:void(0);" onclick="nextGameSetLogPage();" class="forward"></a>';
	str[8]='<a href="javascript:void(0);" onclick="nextGameSetLogMaxPage();" class="forward-fast"></a></p>';
...
function nextGameSetLogMaxPage(){
...
function previousGameSetLogPage(){
