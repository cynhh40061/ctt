...
function f_BW_showTableDefault(){
	...
	str.push('        <ul>');
	str.push('            <li>名稱：<input type="text" name="BW_q_name" class="text-left">IP：<input type="text" name="BW_q_ip" onkeyup="f_BW_checkIP(this, this.value);" class="text-left"></li>');
...
function f_BW_showDetail(id=-1){
	...
	str.push('            <tr>');
	str.push('                <th>ＩＰ</th>');
	str.push('                <td><input type="text" name="BW_ip" onkeyup="f_BW_checkIP(this, this.value);" onchange="checkIpRule(this.value);" class="text-left"></td>');
	str.push('            </tr>');
	str.push('            <tr>');
	str.push('                <th>名稱</th>');
	str.push('                <td><input type="text" name="BW_name" class="text-left"></td>');
	str.push('            </tr>');
	str.push('            <tr>');
	str.push('                <th>描述</th>');
	str.push('                <td><input type="text" name="BW_text" class="text-left"></td>');
	str.push('            </tr>');
	str.push('            <tr>');
	str.push('                <th>所在地區</th>');
	str.push('                <td><input type="text" name="BW_area" class="text-left"></td>');
	str.push('            </tr>');
	str.push('            <tr>');
	str.push('                <th>類型</th>');
